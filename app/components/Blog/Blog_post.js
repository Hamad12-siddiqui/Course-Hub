      ...
      <div className="w-full md:max-w-5xl">
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-4">
          <div className="space-y-3">
            <p className={`border rounded-lg inline-flex text-sm sm:text-base bg-[#E9E2FF] ${textcolor}  ${className} px-3 py-1${BlogName}`}>
              {Blog}
            </p>
          ...
          {showbutton && (
            <div className="mt-2 md:mt-0">
              <div className="w-fit bg-[#704FE6] text-white rounded-3xl flex items-center shadow-md">
                <button onClick={handleClick} className="px-4 py-2 text-sm md:text-base" >Contact us</button>
