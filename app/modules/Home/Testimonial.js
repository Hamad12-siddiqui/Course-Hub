...
const Testimonial = () => {
  return (
    ...
    <div className=" w-full relative flex justify-center items-center mt-20 pt-10 md:px-4 px-0 bg-[url('/images/mapbg.jpg')] bg-cover bg-center">
      ...
      <div className="w-5xl flex flex-col sm:justify-center justify-start sm:items-center items-start px-2 md:mt-10 mt-24">
        <div className="bg-[#E9E2FF] text-[#704FE6]">
          <p className="font-sora font-normal text-sm py-1 md:px-4 px-0 uppercase">
            testimonial
          </p>
        </div>
        <h3 className=" md:max-w-xl w-full md:text-center text-left px-1 font-bold md:text-4xl text-2xl mt-6 capitalize">
