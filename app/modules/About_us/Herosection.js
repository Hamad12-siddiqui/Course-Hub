    ...
    <div className='w-full  bg-cover bg-center bg-no-repeat bg-[url("/images/bg(2).jpg")]'>
        ...
        <div className='max-w-4xl flex justify-between ml-0 md:ml-12'>
            ...
            <div className='flex flex-col items-center'>
                <p className='font-epilogue font-bold text-[40px] uppercase text-[#0E2A46]'>about us</p>
                <div className='space-x-8'>
                    <p className='text-[#0E2A46] font-sora font-normal text-[16px] capitalize '>home<span className='text-[#FC6441] mx-1'>//</span>about us</p>
